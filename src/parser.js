...
const grammar = () => build(`
      ...
      operation ->  (letty _ ":" _):? "function" _ predicate _ "(" _ expression:? _ ")" _ "{" _ expression _ "}" {% 
        ([letty, func, ws1, operation, ws2, p1, ws3, args, w4, p2, ws5, cb1, ws6, result]) => ["^", letty ? letty[0] : [], result, operation, args || []]
      %}
